...
/**
 * This class implements the controller for the Modify Product scene.
 * 
...
public class ProductModifyController implements Initializable {
	...
	/**
	 * This method updates the product in inventory, and saves the information based on user inputs. 
	 * 
	 * @param actionEvent
	 * @throws IOException
	 */
	...
	public void initialize(URL location, ResourceBundle resources) {
		errorMsgDisplay.setText("");
		Product selectedProduct = MainController.selectedProduct;
		idField.setPromptText(Integer.toString(selectedProduct.getId()));
